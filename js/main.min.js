...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}!function(){if("undefined"!=typeof window){var t=window.navigator.userAgent.match(/Edge\/(\d{2})\./),e=t?parseInt(t[1],10):null,i=!!e&&16<=e&&e<=18;if("objectFit"in document.documentElement.style==0||i){var o=function(t,e,i){var o,n,l,a,r;if((i=i.split(" ")).length<2&&(i[1]=i[0]),"x"===t)o=i[0],n=i[1],l="left",a="right",r=e.clientWidth;else{if("y"!==t)return;o=i[1],n=i[0],l="top",a="bottom",r=e.clientHeight}if(o!==l&&n!==l){if(o!==a&&n!==a)return"center"===o||"50%"===o?(e.style[l]="50%",void(e.style["margin-"+l]=r/-2+"px")):void(0<=o.indexOf("%")?(o=parseInt(o,10))<50?(e.style[l]=o+"%",e.style["margin-"+l]=r*(o/-100)+"px"):(o=100-o,e.style[a]=o+"%",e.style["margin-"+a]=r*(o/-100)+"px"):e.style[l]=o);e.style[a]="0"}else e.style[l]="0"},n=function(t){var e=t.dataset?t.dataset.objectFit:t.getAttribute("data-object-fit"),i=t.dataset?t.dataset.objectPosition:t.getAttribute("data-object-position");e=e||"cover",i=i||"50% 50%";var n=t.parentNode;return function(t){var e=window.getComputedStyle(t,null),i=e.getPropertyValue("position"),o=e.getPropertyValue("overflow"),n=e.getPropertyValue("display");i&&"static"!==i||(t.style.position="relative"),"hidden"!==o&&(t.style.overflow="hidden"),n&&"inline"!==n||(t.style.display="block"),0===t.clientHeight&&(t.style.height="100%"),-1===t.className.indexOf("object-fit-polyfill")&&(t.className=t.className+" object-fit-polyfill")}(n),function(t){var e=window.getComputedStyle(t,null),i={"max-width":"none","max-height":"none","min-width":"0px","min-height":"0px",top:"auto",right:"auto",bottom:"auto",left:"auto","margin-top":"0px","margin-right":"0px","margin-bottom":"0px","margin-left":"0px"};for(var o in i)e.getPropertyValue(o)!==i[o]&&(t.style[o]=i[o])}(t),t.style.position="absolute",t.style.width="auto",t.style.height="auto","scale-down"===e&&(e=t.clientWidth<n.clientWidth&&t.clientHeight<n.clientHeight?"none":"contain"),"none"===e?(o("x",t,i),void o("y",t,i)):"fill"===e?(t.style.width="100%",t.style.height="100%",o("x",t,i),void o("y",t,i)):(t.style.height="100%",void("cover"===e&&t.clientWidth>n.clientWidth||"contain"===e&&t.clientWidth<n.clientWidth?(t.style.top="0",t.style.marginTop="0",o("x",t,i)):(t.style.width="100%",t.style.height="auto",t.style.left="0",t.style.marginLeft="0",o("y",t,i))))},l=function(t){if(void 0===t||t instanceof Event)t=document.querySelectorAll("[data-object-fit]");else if(t&&t.nodeName)t=[t];else{if("object"!=_typeof(t)||!t.length||!t[0].nodeName)return!1;t=t}for(var e=0;e<t.length;e++)if(t[e].nodeName){var o=t[e].nodeName.toLowerCase();if("img"===o){if(i)continue;t[e].complete?n(t[e]):t[e].addEventListener("load",(function(){n(this)}))}else"video"===o?0<t[e].readyState?n(t[e]):t[e].addEventListener("loadedmetadata",(function(){n(this)})):n(t[e])}return!0};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",l):l(),window.addEventListener("resize",l),window.objectFitPolyfill=l}else window.objectFitPolyfill=function(){return!1}}}();
...
"use strict";$((function(){var e={win:$(window),body:$("body"),nav:$(".nav"),header:$(".header"),footer:$(".footer"),btnMenu:$(".js-toggle-menu"),closeMenu:$(".js-nav-close"),shadowMenu:$(".nav-shadow"),scrollableElement:document.querySelector(".menu"),eventMenu:function(){var t=e.win.width();e.nav.toggleClass("nav_open"),e.btnMenu.toggleClass("js-toggle-menu_active"),e.shadowMenu.toggleClass("nav-shadow_active"),e.nav.hasClass("nav_open")&&t<1200?scrollLock.disablePageScroll(e.scrollableElement):scrollLock.enablePageScroll(e.scrollableElement)}};function t(e,t){var s,n=0,a='<div class="err_mess">Заполните обязательные поля!</div>',o=t||!1,l=$(e),i=l.data("ajax"),r=l.find('input[type="email"].chk'),c=r.val();if(l.find(".err_mess,.complete").remove(),l.find(".chk").each((function(){var e=$(this);e.val()?(e.hasClass("inputfile")&&e.closest(".file").removeClass("file_err"),e.removeClass("err"),e.next(".selected").removeClass("err")):(e.hasClass("inputfile")&&e.closest(".file").addClass("file_err"),e.addClass("err"),l.find(".err_mess").remove(),l.find(".form-message").html(a),n=1)})),r.length&&(s=c,new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i).test(s)?r.removeClass("err"):(r.addClass("err"),l.find(".err_mess").remove(),l.find(".form-message").html(a),n=1)),0===n){if(void 0!==i){l.find("[type=submit]").prop("disabled",!0);var d=new FormData(l.get(0));return!1!==o&&d.append(o.attr("name"),o.val()),$.ajax({type:"POST",url:i,data:d,processData:!1,contentType:!1,dataType:"html",success:function(e){l.find(".err_mess,.complete").remove(),l.find("[type=submit]").prop("disabled",!1),"Y"===(d=JSON.parse(e)).result?(l.find('input:not([type="submit"],[type="hidden"]),textarea').val(""),l.find(".form-message").html(d.txt)):l.find(".form-message").html(d.txt)}}),!1}return l.find(".err_mess,.complete").remove(),!0}return l.find(".err_mess,.complete").remove(),l.find(".form-message").html(a),!1}svg4everybody(),e.btnMenu.on("click",(function(){e.eventMenu()})),e.closeMenu.on("click",(function(){e.eventMenu()})),e.shadowMenu.on("click",(function(){e.eventMenu()})),objectFitPolyfill($(".object-fit")),$(".js-scroll").on("click",(function(t){t.preventDefault();var s,n=$(this).attr("href"),a=(e.win.outerWidth(),e.header.outerHeight());$(n).length&&(s=$(n).offset().top-a+5),e.eventMenu(),$("body,html").animate({scrollTop:s},1e3,(function(){$(".js-scroll").removeClass("menu__lnk_active"),$('.js-scroll[href="'+n+'"]').addClass("menu__lnk_active")}))})),e.win.scroll((function(){var t,s,n,a=e.win.scrollTop(),o=(e.win.outerWidth(),$(this).scrollTop());e.header.outerHeight(),a>0?e.header.hasClass("header_fixed")||e.header.addClass("header_fixed"):e.header.removeClass("header_fixed"),o>$(this).height()?$(".js-up").addClass("js-up_show"):$(".js-up").removeClass("js-up_show"),$(".js-scroll-block").each((function(a){t=$(this),s=t.attr("id"),n=$(".menu__link_active").attr("href");var o=t.position().top,l=t.outerHeight()+o,i=e.win.scrollTop()+e.header.outerHeight()+5;i>=o&&i<l&&"#"+s!=n?($(".js-scroll").removeClass("menu__link_active"),$('.js-scroll[href="#'+s+'"]').addClass("menu__link_active")):i<o&&0===a&&$(".js-scroll").removeClass("menu__link_active")}))})),e.win.scroll(),$(".js-up").on("click",(function(){$("body,html").animate({scrollTop:0},700)})),e.body.on("click",".js-mobile-switch, .js-package-slider-switch",(function(){$(this).closest(".package-slider__item").toggleClass("show-inner")})),new Swiper(".package-slider",{slidesPerView:"auto",grabCursor:!0,centeredSlides:!0,spaceBetween:!1,navigation:{nextEl:".slider-button--next",prevEl:".slider-button--prev"},breakpoints:{599:{spaceBetween:24,centeredSlides:!1}}}),e.body.on("click",".js-popup-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade",closeExisting:!0,afterClose:function(){$('.popup input:not([type="submit"]),.popup textarea').removeClass("err"),$(".popup .err_mess,.popup .complete").remove()}}})})),e.body.on("click",".js-ajax-lnk",(function(e){e.preventDefault(),$.fancybox.open({src:$(this).attr("href"),type:"ajax",opts:{buttons:!1,smallBtn:!1,touch:!1,animationEffect:"fade"}})})),$(".my-field_tel").mask("+375 (99) 999-99-99"),e.body.on("click",".js-tabs-lnk",(function(e){e.preventDefault();var t=$(this),s=t.closest(".js-tabs-wrp"),n=s.find(".js-tabs-lnk"),a=s.find(".js-tab"),o=t.attr("href");n.removeClass("js-tabs-lnk_active"),s.find('.js-tabs-lnk[href="'+o+'"]').addClass("js-tabs-lnk_active"),a.removeClass("js-tab_show"),(a=$(o)).addClass("js-tab_show")})),e.body.on("click",".file__info",(function(){$("input",this.parentNode).click()})),e.body.on("change",".inputfile",(function(){var e=$(this),t=e.closest(".file-wrapper"),s=t.find(".file__path"),n=t.find(".file__del"),a=s.attr("data-nofile"),o=e.val(),l=o.replace("C:\\fakepath\\","");""!==o?(s.text(l),n.addClass("show")):(s.text(a),n.removeClass("show"))})),e.body.on("click",".file__del",(function(){var e=$(this).closest(".file-wrapper"),t=e.find(".file__path"),s=t.attr("data-nofile"),n=e.find(".file__del");e.find(".inputfile").val(""),t.text(s),n.removeClass("show")})),e.body.on("change, keyup",'input:not([type="file"],input:not([type="submit"],[type="hidden"]),textarea',(function(){var e=$(this);e.hasClass("err")&&e.val()&&e.removeClass("err")})),e.body.on("submit","form",(function(e){if(void 0===$(this).attr("data-ajax"))return t(this);e.preventDefault()})),e.body.on("click","[type = submit]",(function(){return t($(this).closest("form"),$(this))})),window.vaObj=e}));